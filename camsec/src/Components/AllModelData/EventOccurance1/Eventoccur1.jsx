...
import { Eventphotos } from "./Eventphotos1";
  ...
  render() {
    return (
      <div className="events">
        ...
        <div style={{marginLeft:'10%',marginTop:'3.2%'}}>Mask Alert
        </div>
        <button className="event-btn-alert12"><AiOutlineDownload 
         style={{marginRight:'10px'}} />Download CSV</button>
        </div>

        <div className="event-page34 event-btns4">
        {/* <div className="event-btns">
        <button className="event-btn-alert">Mask Alert</button>
