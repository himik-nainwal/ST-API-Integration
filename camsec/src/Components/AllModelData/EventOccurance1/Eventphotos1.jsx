           ...
           <tr>
                {
                   column.map((v)=>{
                     if(v=='Image')
                     {
                      return <td style={{borderBottom:'none',borderLeft:'1px solid white'
                        ,borderRight:'0.2px solid white',
                        display:'flex',justifyContent:'center'}}><img  src='./logo192.png' 
                        width='40'></img></td>
                     }
                     else
                     {
                       return <td style={{borderBottom:'none',borderLeft:'1px solid white'
                        ,borderRight:'0.2px solid white',justifyContent:'center',color:'white'}}>{data[v]}</td>
                     }
                      })
                }
           </tr>
